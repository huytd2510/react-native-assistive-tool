...
const KeyValueTable = () => {
  ...
  const loadMoreData = () => {
    ...
    const additionalData = filteredData.concat(data.slice(startIndex, startIndex + PAGE_SIZE));
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    ListFooterComponent: loading ? /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, "Loading...") : null
  }));
};
